...
class Main_ManualTest extends \Praxigento\Core\Test\BaseCase\Mockery {
    ...
    public function test_construct() {
        ...
        /** @var  $repo \Praxigento\BonusBase\Repo\IModule */
        $repo = $obm->get(\Praxigento\BonusBase\Repo\IModule::class);
        $this->assertTrue($repo instanceof \Praxigento\BonusBase\Repo\Def\Module);
    }
